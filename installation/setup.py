...
setup(name='hil_audit',
      maintainer='Developers of the HIL Project at MOC',
      maintainer_email='hil@lists.massopen.cloud',
      url='https://github.com/BU-NU-CLOUD-SP18/Auditing-for-HW-as-a-Service-cloud',
      description='An auditing service for the existing Hardware Isolation Layer (HIL) '
                  'and network switches which are controlled by the HIL service. ',
      ...
      keywords='cloud bare-metal setuptools data-center isolation auditing',
      setup_requires=['setuptools_scm'],
      use_scm_version=True,
      packages=find_packages(),
      # TODO: we should merge scripts into entry_points, below.
      scripts=['scripts/hil_audit'],
      #entry_points={
